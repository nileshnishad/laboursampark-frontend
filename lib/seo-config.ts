...
export const primaryKeywords = [
  ...
  "skilled labour jobs",
  "contractor jobs India",
  "verified labourer hire",
  "direct labour connect",
  "construction project manager",
  "building contractors India",
  "interior workers hire",
  "civil work labourers",
  "temporary construction staff",
  "daily wage workers India",
  "best labour app India",
...
export const secondaryKeywords = [
  ...
  "skilled job opportunities for labourers",
  "hire trusted contractors for home repair",
  "where to find reliable plumbers in India",
  "electrician services for new house",
  "best site to hire painters",
  "labour management for construction projects",
  "connect with verified workers directly",
  "hassle free labour hiring India",
  "affordable construction worker hire",
  "expert contractors for renovation",
  "skilled manpower for civil works",
  "on demand labour services India",
  "digital platform for construction workers",
];
