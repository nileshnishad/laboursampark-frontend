  ...
  return (
    <div className="flex items-center gap-2 pt-1">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[10px] sm:text-[11px] font-semibold text-zinc-700 dark:text-zinc-300 truncate">{name}</p>
        <p className="text-[9px] text-zinc-400 capitalize">{displayType}</p>
      </div>
      {mobile && (
        <a
          href={`tel:+91${mobile}`}
