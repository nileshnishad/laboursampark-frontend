  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg h-[75vh] flex flex-col">
        ...
        {/* HEADER */}
        <div className="bg-linear-to-r from-green-600 to-green-500 dark:from-blue-700 dark:to-blue-600 p-4 sm:p-6 flex gap-4 items-start border-b border-blue-400">
          {/* Profile Photo */}
